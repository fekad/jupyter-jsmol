...
3]=Ia.w,ha+=4;g.bindBuffer(g.ARRAY_BUFFER,$.buffer);g.bufferData(g.ARRAY_BUFFER,$.array,Cc)}}}X.verticesNeedUpdate=!1;X.colorsNeedUpdate=!1;Ha.attributes&&q(Ha)}else Wa instanceof THREE.ParticleZystem&&(Ha=c(Wa,Tb),Mb=Ha.attributes&&n(Ha),(X.verticesNeedUpdate||X.colorsNeedUpdate||Wa.sortParticles||Mb)&&f(X,g.DYNAMIC_DRAW,Wa),X.verticesNeedUpdate=!1,X.colorsNeedUpdate=!1,Ha.attributes&&q(Ha))}};this.initMaterial=function(a,b,c,d){var e,f,h;a instanceof THREE.MeshDepthMaterial?h="depth":a instanceof
...
b=new THREE.Line(a.geometry,a.material,a.type):a instanceof THREE.Ribbon?b=new THREE.Ribbon(a.geometry,a.material):a instanceof THREE.ParticleZystem?(b=new THREE.ParticleZystem(a.geometry,a.material),b.sortParticles=a.sortParticles):a instanceof THREE.Particle?b=new THREE.Particle(a.material):a instanceof THREE.Sprite?(b=new THREE.Sprite({}),b.color.copy(a.color),b.map=a.map,b.blending=a.blending,b.useScreenCoordinates=a.useScreenCoordinates,b.mergeWith3D=a.mergeWith3D,b.affectedByDistance=a.affectedByDistance,
