...
var tokens;
if (value == null) {
Zystem.out.println ("model " + modelIndex + " has no _M.properties.FreqValue");
}if (freq == null) {
Zystem.out.println ("model " + modelIndex + " has no _M.properties.Frequency");
} else {
tokens = JU.PT.split (freq, " ");
if (tokens.length == 1) {
Zystem.out.println ("model " + modelIndex + " has no frequency units");
