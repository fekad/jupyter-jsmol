...
}Zystem.out.println ("Object " + this.objectName + " nBonds=" + nBonds + ", nAtoms = " + nAtoms);
for (var j = 0; j < ns; j++) {
...
Zystem.out.println ("PyMOL atom dump version " + ver);
...
Zystem.out.println ("PyMOL bond dump version " + ver);
