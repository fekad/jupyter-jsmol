...
Jmol.Console.Image = function(vwr, title, imageMap) {
  ...
  Zystem.out.println("image " + this.id + " created");
...
Jmol.Console.Input = function(console) {
    ...
    //Zystem.out.println(ev.type + " key:" + (!ev.key) + " keyCode:" + ev.keyCode + " which:" + ev.which + " " + ev.key + "--" + ev.originalEvent.keyIdentifier);
...
if (menuMap != null) {
if (key.indexOf ("NMR.") >= 0) Zystem.out.println ("genericconsole mapping " + key + " to " + label);
