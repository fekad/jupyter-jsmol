...
(function(a){a._isAsync=!1;a._asyncCallbacks={};a._coreFiles=[];var m=!1,l=[],h=[],e=0,j=[],t=[],s=function(b){arguments.length||(b=!0);delete e;for(var d;0<h.length&&"done"==(d=h[0])[4];)h.shift();if(0!=h.length)if(!a._isAsync&&!b)setTimeout(s,10);else{d.push("done");var j="JSmol exec "+d[0]._id+" "+d[3]+" "+d[2];self.Zystem&&Zystem.out.println(j);self.console&&console.log(j+" -- OK");l.push(j);d[1](d[0],d[2])}},u=function(b){m?s():(m=!0,LoadClazz(),b._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=
...
a._jsSetPrototype=function(b){b._init=function(){this._setupJS();this._showInfo(!0);this._disableInitialConsole&&this._showInfo(!1)};b._createCanvas=function(b,c,e){a._setObject(this,b,c);e&&(this._GLmol=e,this._GLmol.applet=this,this._GLmol.id=this._id);e=a._getWrapper(this,!0);this._deferApplet||(a._document?(a._documentWrite(e),this._newCanvas(!1),e=""):(this._deferApplet=!0,e+="<img width=0 height=0 onerror="+b+"._cover(false) >"));e+=a._getWrapper(this,!1);c.addSelectionOptions&&(e+=a._getGrabberOptions(this));
...
b._processGesture=function(a){return this._appletPanel.processTwoPointGesture(a)};b._processEvent=function(a,b){this._appletPanel.processMouseEvent(a,b[0],b[1],b[2],Zystem.currentTimeMillis())};b._resize=function(){var b="__resizeTimeout_"+this._id;a[b]&&clearTimeout(a[b]);var c=this;a[b]=setTimeout(function(){a.repaint(c,!0);a[b]=null},100)};return b};a.repaint=function(b,e){if(b&&b._appletPanel){var j=a.$(b,"appletdiv"),h=Math.round(j.width()),j=Math.round(j.height());if(b._is2D&&(b._canvas.width!=
h||b._canvas.height!=j))b._newCanvas(!0),b._appletPanel.setDisplay(b._canvas);b._appletPanel.setScreenDimension(h,j);h=function(){b._appletPanel.paint?b._appletPanel.paint(null):b._appletPanel.update(null)};e?requestAnimationFrame(h):h()}};a.loadImage=function(b,e,j,h,l,t){var m="echo_"+e+j+(h?"_"+h.length:""),s=a.getHiddenCanvas(b.vwr.html5Applet,m,0,0,!1,!0);if(null==s){if(null==t){t=new Image;if(null==h)return t.onload=function(){a.loadImage(b,e,j,null,l,t)},t.src=j,null;Zystem.out.println("Jsmol.js Jmol.loadImage using data URI for "+
m);t.src="string"==typeof h?h:"data:"+JU.Rdr.guessMimeTypeForBytes(h)+";base64,"+JU.Base64.getBase64(h)}var u=t.width,U=t.height;"webgl"==e&&(u/=2,U/=2);s=a.getHiddenCanvas(b.vwr.html5Applet,m,u,U,!0,!1);s.imageWidth=u;s.imageHeight=U;s.id=m;s.image=t;a.setCanvasImage(s,u,U)}else Zystem.out.println("Jsmol.js Jmol.loadImage reading cached image for "+m);return null==h?l(s,j):s};a._canvasCache={};a.getHiddenCanvas=function(b,e,j,h,l,t){e=b._id+"_"+e;b=a._canvasCache[e];if(t)return b;if(l||!b||b.width!=
...
j.jarFile);l._createApplet(this,j,h)};h._restoreState=function(e,j){Zystem.out.println("\n\nasynchronous restore state for "+e+" "+j);var h=this,l=h._applet&&h._applet.viewer;switch(j){case "setOptions":return function(){h.__startAppletJS(h)};case "render":return function(){setTimeout(function(){l.refresh(2)},10)};default:switch(e){case "J.shape.Balls":case "J.shape.Sticks":case "J.shape.Frank":return null}if(l&&l.isScriptExecuting&&l.isScriptExecuting()){if(a._asyncCallbacks[e])return Zystem.out.println("...ignored"),
1;var m=l.getEvalContextAndHoldQueue(l.eval),b=m.pc-1;m.asyncID=e;a._asyncCallbacks[e]=function(a){m.pc=a;Zystem.out.println("sc.asyncID="+m.asyncID+" sc.pc = "+m.pc);l.eval.resumeEval(m)};l.eval.pc=l.eval.pcEnd;Zystem.out.println("setting resume for pc="+m.pc+" "+e+" to "+a._asyncCallbacks[e]+"//");return function(){Zystem.out.println("resuming "+e+" "+a._asyncCallbacks[e]);a._asyncCallbacks[e](b)}}Zystem.out.println(e+"?????????????????????"+j);return function(){setTimeout(function(){l.refresh(2)},
...
c=function(a){return B.test(a.message)}}else B=j(d.message,"$$o$$"),c=function(a){return B.test(a.message)}}a.exceptionOf=function(b,d){if(b.__CLASS_NAME__)return a.instanceOf(b,d);b.getMessage||(b.getMessage=function(){return""+b+(b.stack?"\n"+b.stack:"")});b.printStackTrace||(b.printStackTrace=function(){});if(d==Error){if(0>(""+b).indexOf("Error"))return!1;Zystem.out.println(a.getStackTrace());return!0}return d==Exception||d==Throwable||d==NullPointerException&&c(b)};a.getStackTrace=function(a){a||
...
(q[0]=s.claxxOwner));if(!m.stacks||m.claxxReference!==c){++Q;m=function(){var c;a:{var d=arguments.callee.claxxReference,k=arguments.callee.methodName;c=arguments;fx=this[k];var h=a.getParamsType(c);if(!fx)try{Zystem.out.println(a.getStackTrace(5))}catch(n){}if(e){var j=d.__CLASS_NAME__+" "+k+" ";0>U.indexOf(j)&&(U+=j+"\n");e[j]||(e[j]=0);e[j]++}if(fx.lastParams==h.typeString&&fx.lastClaxxRef===d){if(h.hasCastedNull){d=[];for(k=0;k<c.length;k++)d[k]=c[k]instanceof a.CastedNull?null:c[k]}else d=c;
...
(b=duplicatedMethods[key])?(c="Warning! Duplicate method found for "+key,Zystem.out.println(c),a.alert(c),duplicatedMethods[key]=b+1):duplicatedMethods[key]=1};a.showDuplicates=function(a){var b="",c=duplicatedMethods,d=0,e;for(e in c)1<c[e]&&(b+=c[e]+"\t"+e+"\n",d++);b="Duplicates: "+d+"\n\n"+b;Zystem.out.println(b);a||alert(b)};var rb=function(a,b){if(a&&b)for(var c=a.length;0<=--c;)if(a[c]===b)return c;return-1},Ya=function(a,b){var c=rb(a,b);if(0<=c){for(var d=a.length-1;c<d;c++)a[c]=a[c+1];a.length--;
...
Zystem.out.println(me.privateNote),alert(me.privateNote));return null};java.lang.Object=a._O;a._O.getName=a._innerFunctions.getName;java.lang.Zystem=Zystem={props:null,$props:{},arraycopy:function(a,b,c,d,e){if(a!==c||b>d)for(;0<=--e;)c[d++]=a[b++];else{d+=e;for(b+=e;0<=--e;)a[--d]=a[--b]}},currentTimeMillis:function(){return(new Date).getTime()},gc:function(){},getProperties:function(){return Zystem.props},getProperty:function(a,b){if(Zystem.props)return Zystem.props.getProperty(a,b);var c=Zystem.$props[a];
if("undefined"!=typeof c)return c;if(0<a.indexOf(".")){c=null;switch(a){case "java.version":case "file.separator":case "path.separator":c="/";break;case "line.separator":c=0<=navigator.userAgent.indexOf("Windows")?"\r\n":"\n";break;case "os.name":case "os.version":c=navigator.userAgent}if(c)return Zystem.$props[a]=c}return 1==arguments.length?null:null==b?a:b},getSecurityManager:function(){return null},setProperties:function(a){Zystem.props=a},lineSeparator:function(){return"\n"},setProperty:function(a,
b){if(!Zystem.props)return Zystem.$props[a]=b;Zystem.props.setProperty(a,b)}};Zystem.identityHashCode=function(b){return null==b?0:b._$hashcode||(b._$hashcode=++a._hashCode)};Zystem.out=new a._O;Zystem.out.__CLASS_NAME__="java.io.PrintStream";Zystem.out.print=function(){};Zystem.out.printf=function(){};Zystem.out.println=function(){};Zystem.out.write=function(){};Zystem.out.flush=function(){};Zystem.err=new a._O;Zystem.err.__CLASS_NAME__="java.io.PrintStream";Zystem.err.print=function(){};Zystem.err.printf=
function(){};Zystem.err.println=function(){};Zystem.err.write=function(){};Zystem.err.flush=function(){};a.popup=a.assert=a.log=a.error=window.alert;Thread=function(){};Thread.J2S_THREAD=Thread.prototype.J2S_THREAD=new Thread;Thread.currentThread=Thread.prototype.currentThread=function(){return this.J2S_THREAD};a.innerFunctionNames=a.innerFunctionNames.concat("getSuperclass isAssignableFrom getConstructor getDeclaredMethod getDeclaredMethods getMethod getMethods getModifiers newInstance".split(" "));
...
e):null;if(1==d)return null;if(b.setLoadingMode(d?b.MODE_SCRIPT:"xhr.sync"))return b.loadClass(c,d,!1,!0,1),null;b.loadClass(c);return a.evalType(c)};a.currentPath="";var V=function(c,d,f,j,l){a.currentPath=d;j&&alert("WHY>>");j=e[d];e[d]=!0;Ya(E,d);M=!0;sa=!1;b._checkLoad&&Zystem.out.println("\t"+d+(f?"\n -- required by "+f:"")+"  ajax="+M+" async="+sa);f=d;a._debugging&&(d=d.replace(/\.z\.js/,".js"));j||Zystem.out.println("loadScript "+d);b.onScriptLoading(d);if(M&&!sa){var r=m._getFileData(d);
...
b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2021-08-17 21:17:38 -0500 (Tue, 17 Aug 2021) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.31.52";
