...
var cr = this.cr;
var key = cr.key;
if (key.equals ("_cell_subZystem_code")) return this.processSubZystemLoopBlock ();
...
Clazz.defineMethod (c$, "processSubZystemLoopBlock",
 function () {
var cr = this.cr;
...
var id = this.field;
this.addSubZystem (id, this.getSparseMatrix (cr, "_w_", 1, 3 + this.modDim));
}
return 1;
});
