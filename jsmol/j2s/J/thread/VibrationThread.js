...
case -1:
this.lastRepaintTime = this.startTime = Zystem.currentTimeMillis ();
this.vwr.startHoverWatcher (false);
this.haveReference = true;
mode = 0;
break;
case 0:
elapsed = (Zystem.currentTimeMillis () - this.lastRepaintTime);
this.sleepTime = 33 - elapsed;
if (!this.runSleep (this.sleepTime, 1)) return;
mode = 1;
break;
case 1:
this.lastRepaintTime = Zystem.currentTimeMillis ();
