...
# -*- coding: utf-8 -*-
#
# jupyter_jsmol documentation build configuration file
#
...
project = 'jupyter_jsmol'
copyright = '2020, Adam Fekete'
author = 'Adam Fekete'
...
htmlhelp_basename = 'jupyter_jsmoldoc'
...
latex_documents = [
    (master_doc, 'jupyter_jsmol.tex', 'jupyter_jsmol Documentation',
     'Adam Fekete', 'manual'),
]
